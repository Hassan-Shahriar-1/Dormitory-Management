...
@section('content')
    <div class="container">
        <div class="portlet portlet-boxed portlet-table">
            ...
            <div class="portlet-body">
                ...
                <table
                    class="table table-striped table-bordered table-hover room-table"
                ...
                >
                    <thead>
                        <tr>
                            ...
                            <th data-sortable="false" class="w-60p text-center">Room Number</th>
                            <th data-sortable="false" class="mw-180p">Description</th>
                            <th data-sortable="false" class="">Number Of Beds</th>
    ...
    {{-- modal partial --}}
    @include('admin.partials.modals.room-modal')
...
@section('js')
    ...
    @include('admin.room.page_script')
@endsection
